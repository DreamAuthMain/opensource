...
import { JwtDecoder, JwtFactory, JwtVerifier } from './src/index.js';
...
const jwtFactory = new JwtFactory('https://issuer.com', {
...
const verifier = new JwtVerifier(['https://issuer.com'], {
  loader: {
